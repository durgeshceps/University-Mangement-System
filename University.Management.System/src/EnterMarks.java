...
//        setLayout(null);
//
//        l1 = JLabel("Enter marks of Student");
...
//                    conn c1 = new conn();
//
//                    String s1 = "insert into subject values('"+t1.getText()+"','"+t2.getText()+"','"+t4.getText()+"','"+t8.getText()+"','"t10.getText()+"')";
//                    String s2 = "insert into subject values('"+t1.getText()+"','"+t3.getText()+"','"+t5.getText()+"','"+t7.getText()+"','"t9.getText()"')";
//
