...
//            try{
//                conn cc = new conn();
//                String q = "insert inte student values('"+a+"','"+bb+"','"+c+"' ,'"+d+"', '"+e+"', '"+ff+"', '"+g+"' ,'"+h+"' ,'"+i+"' ,'"+j+"' ,'"+k+"' ,'"+l+"' ,'"+m+"' " ;
...
public class AddStudent extends JFrame implements ActionListener {
    ...
    JLabel id1,id2,id3,id4,id5,id6,id7,id8,id9,id12,lab,lab1;
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                conn cc = new conn();
                String q = "insert into student values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+k+"','"+l+"','"+m+"')";
                cc.s.executeUpdate(q);
                JOptionPane.showMessageDialog(null,"Student Details Inserted Successfully");
                setVisible(false);
